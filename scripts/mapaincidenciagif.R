...
Mapa_inci <- function(capa_son, capa_munison_casos) { ggplot(capa_munison_casos, aes(map_id = id)) +
    ...
    theme(plot.title = (element_text(family = "Lato Black", size = 54, color = "black")),
          ...
          axis.title = element_blank()) +
    labs(axis = NULL, y = NULL, x = NULL, title = "Incidencia semanal", subtitle = "Casos confirmados de covid-19 dentro de los 7 días previos\na la fecha señalada por 100 mil habitantes",
